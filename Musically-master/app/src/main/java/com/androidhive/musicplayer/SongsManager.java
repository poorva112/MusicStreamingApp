...
import com.androidhive.musicplayer.AndroidBuildingMusicPlayerActivity;
...
// return songs list array
	...
	public void get_cloud_music(final boolean local_loaded,final Context context){
		//Context con=context;
		if(local_loaded==false)
		{
			Log.d("fetching local","meh");
			getPlayList();
		}
